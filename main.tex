...
\linespread{1.1} % Rozteč řádků
\usepackage[a4paper, lmargin=0.09\paperwidth, rmargin=0.12\paperwidth, tmargin=0.09\paperheight, bmargin=0.09\paperheight]{geometry} % Margins
\usepackage[all]{nowidow}
\usepackage{fancyhdr} % Kontituly a číslo stránky
\usepackage{lineno}
\usepackage{xcolor}
\usepackage{listings} % Vypis zdrojoveho kodu
\lstset{
  language=Python,
...
\renewcommand{\rmdefault}{cmr} % Nastavení výchozího fontu
